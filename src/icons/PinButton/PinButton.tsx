...
export const PinButton = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`pin-button ${className}`}
      fill="none"
      height="38"
      viewBox="0 0 38 38"
      width="38"
    ...
    >
      <g className="g" filter="url(#filter0_d_200_7337)">
        <circle className="circle" cx="18.8902" cy="14.8902" fill="white" r="14.8902" />
      </g>
      <g className="g" clipPath="url(#clip0_200_7337)">
        <path
          className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_200_7337" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_200_7337"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_200_7337">
